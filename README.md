# Data-Structer
Veri Yapıları dersinde bağlı listeler (Linked List) konusu 4 ana başlıkta incelenir.
tek yönlü bağlı liste (tyb),
çift yönlü bağlı liste (cybl),
dairesel tek yönlü bağlı liste (dtybl),
 dairesel çift yönlü bağlı liste (dcybl).
